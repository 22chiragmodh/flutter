...
class _OrdersScreenState extends State<OrdersScreen>
  ...
  Future<List<Map<String, dynamic>>> getOrder({String? status}) async {
    try {
      ...
      final orderLengthNotifier =
          Provider.of<OrderLengthNotifier>(context, listen: false);
      if (response.statusCode == 200) {
        ...
        orderLengthNotifier.setOrderLength(orderList.length);
        ...
        children: [
          ...
          Container(
            ...
            child: TabBarView(controller: _controller, children: [
              FutureBuilder(
                  future: getOrder(status: "recieved"),
                  builder: (context, snapshot) {
                    if (snapshot.connectionState == ConnectionState.waiting) {
                      ...
                      return Center(
                          child: Image.asset("assets/images/noitem.jpg"));
                    } else {
